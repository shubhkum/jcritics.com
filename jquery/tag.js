...
//if button has class following
    ...
    $.post('ajax/ajax_pro_india.php',{Untag:receiver}); 
...
//if button has class following
    if($button.hasClass('tagged')){
    //send ajax request to ajax.php for unfollow
    $.post('ajax/ajax_anti_india.php',{Untag:receiver}); 
...
//if button has class following
    if($button.hasClass('tagged')){
    //send ajax request to ajax.php for unfollow
    $.post('ajax/ajax_pro_bjp.php',{Untag:receiver}); 
...
//if button has class following
    if($button.hasClass('tagged')){
    //send ajax request to ajax.php for unfollow
    $.post('ajax/ajax_leftist.php',{Untag:receiver}); 
...
//if button has class following
    if($button.hasClass('tagged')){
    //send ajax request to ajax.php for unfollow
    $.post('ajax/ajax_rightist.php',{Untag:receiver}); 
...
//if button has class following
    if($button.hasClass('tagged')){
    //send ajax request to ajax.php for unfollow
    $.post('ajax/ajax_pro_cong.php',{Untag:receiver}); 
