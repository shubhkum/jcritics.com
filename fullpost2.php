...
<body>
		...
		<div class="row"><!--Row-->
			...
			<div class="col">
				...
				<div class="rating_block clearfix">
					...
					$receiver_id=$_GET['id'];
					$query="SELECT * FROM pro_india_portal WHERE sender='$user_id' AND receiver='$receiver_id'";
					...
					$user_id=$_SESSION['user_id'];
					$receiver_id=$_GET['id'];
					$query="SELECT * FROM anti_india_portal WHERE sender='$user_id' AND receiver='$receiver_id'";
					$execute=mysqli_query($con,$query);
					$row=mysqli_fetch_array($execute);
					if($row){  
					...
					$user_id=$_SESSION['user_id'];
					$receiver_id=$_GET['id'];
					$query="SELECT * FROM pro_bjp_portal WHERE sender='$user_id' AND receiver='$receiver_id'";
					$execute=mysqli_query($con,$query);
					$row=mysqli_fetch_array($execute);
					if($row){
					...
					$user_id=$_SESSION['user_id'];
					$receiver_id=$_GET['id'];
					$query="SELECT * FROM pro_cong_portal WHERE sender='$user_id' AND receiver='$receiver_id'";
					$execute=mysqli_query($con,$query);
					$row=mysqli_fetch_array($execute);
					if($row){
					...
					$user_id=$_SESSION['user_id'];
					$receiver_id=$_GET['id'];
					$query="SELECT * FROM leftist_portal WHERE sender='$user_id' AND receiver='$receiver_id'";
					$execute=mysqli_query($con,$query);
					$row=mysqli_fetch_array($execute);
					if($row){
					...
					$user_id=$_SESSION['user_id'];
					$receiver_id=$_GET['id'];
					$query="SELECT * FROM rightist_portal WHERE sender='$user_id' AND receiver='$receiver_id'";
					$execute=mysqli_query($con,$query);
					$row=mysqli_fetch_array($execute);
					if($row){ 
	    	...
	    	<div class="row">	
				<div class="col-6" id="comment_block">
		            ...
		            global $con;
				 	$postid=$_GET['id'];
				 	$query="SELECT * FROM comments_portal WHERE admin_panel_id='$postid'";
				 	$execute=mysqli_query($con,$query);
				 	while ($datarows=mysqli_fetch_array($execute)) {
			   ...
			   <!--Adding Comment-->
				...
				<div style="margin-top: 25px;" class="çol-4">
					<form action="ajax/ajax_comments_portals.php?id=<?php echo $_GET['id'];?>"method="post" class="form-inline" id="comment_form">
	...
	<!--footer Ending-->
    <!--Script Start-->
		<script type="text/javascript" src="jquery/tag_portal.js">
		</script>
		<script type="text/javascript" src="jquery/comment.js"></script>
		<script type="text/javascript" src="jquery/rating_portal.js"></script>
</body>
</html>