			...
			<!--<form class="form-inline my-2 my-lg-0" style="margin-left: 212px;" method="post">
		     ...
		     <form class="form-inline" action="search.php" method="GET" name="search_form">
	            <div class="input-group">                    
	                <input type="text" class="form-control" placeholder="Search portals, News Portals.." style="width:270px;margin-left: 70px;font-size: 17px;" name="search_text">
			...
			<div class="col-sm-12">
				<div class="clearfix justify-content-center">			
						...
						if(isset($_POST['search'])){
							$search=$_POST['search'];
							$viewquery="SELECT * FROM portals WHERE datetime LIKE '%$search%' OR title LIKE '%$search%' OR category LIKE '%$search%' OR post LIKE '%$search%'";

						}
						elseif (isset($_GET['category'])) {
							$category=$_GET['category'];
							$viewquery="SELECT * FROM portals WHERE category='$category' ORDER BY datetime DESC";
						}
